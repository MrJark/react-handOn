...
export const App = () => {
    ...
    // los estilos que tiene el div son para que siga al mouse
    // el top y left es -30 pòrque es la mitad del width y height para que así se quede centrado
    return (
        <main className="section-center">
            <div
                style={{
                    position: 'absolute',
                    backgroundColor: '#ab79dd',
                    borderRadius: '50%',
                    opacity: '0.25',
                    pointerEvents: 'none',
                    left: '-30px',
